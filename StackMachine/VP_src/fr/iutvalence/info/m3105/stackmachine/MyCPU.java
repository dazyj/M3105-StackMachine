...
public class MyCPU implements CPU
{
	...
	/* (non-Javadoc)
	 * @see fr.iutvalence.info.m3105.stackmachine.MaMachine#run()
	 */
	@Override
	public void run()
	{
	...
	/* (non-Javadoc)
	 * @see fr.iutvalence.info.m3105.stackmachine.MaMachine#wireToExpStack(fr.iutvalence.info.m3105.stackmachine.Stack)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see fr.iutvalence.info.m3105.stackmachine.MaMachine#wireToCallStack(fr.iutvalence.info.m3105.stackmachine.Stack)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see fr.iutvalence.info.m3105.stackmachine.MaMachine#wireToIoSubsystem(fr.iutvalence.info.m3105.stackmachine.IO)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see fr.iutvalence.info.m3105.stackmachine.MaMachine#wireToProgramMemory(fr.iutvalence.info.m3105.stackmachine.Memory)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see fr.iutvalence.info.m3105.stackmachine.MaMachine#clearStacks()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see fr.iutvalence.info.m3105.stackmachine.MaMachine#setPC(int)
	 */
	@Override
